...
ScriptPromise.from = function (name, parent, fn, onerror) {
  var self = this;
...
exports = module.exports = function exposeRequire (opts) {
  ...
  return function (req, res, next) {
    var url = req.url;
    if (opts.prefix) {
      if (url.indexOf(opts.prefix) === -1) return next();
      url = url.replace(opts.prefix, '');
    }
...
var compileAll = exports.compileAll = function compileAll (script, fn) {
  script.once('loaded', function (noDeps) {
    if (noDeps) {
